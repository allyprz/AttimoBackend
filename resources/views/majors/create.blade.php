...
<div class="grid max-w-[900px] gap-4 bg-white rounded-sm my-4 mx-auto p-6">
    ...
    <form action="" method="POST" class="grid gap-4 w-full">
        @csrf
            ...
            <div class="grid gap-4 w-full">
                <div class="flex gap-4 items-center">
                    ...
                    <div class="w-full">
                        ...
                        <select name="coordinator" id="coordinador" class="w-full focus:outline-none p-2 border-2 border-clr-light-gray/40 rounded-md mt-2">
                    ...
                    <div class="w-full">
                        ...
                        <input type="text" name="code" id="code" class="w-full focus:outline-none p-2 border-2 border-clr-light-gray/40 rounded-md mt-2" placeholder="Username">
                    </div>
                </div>
            </div>
        </div>
            ...
            <table class="table min-w-full text-center text-sm text-clr-dark-gray">
                ...
                <tbody>
                    ...
                    <tr class="border-b border-neutral-200 dark:border-white/10">
                        <td class="py-2"><input type="checkbox" name="user_id" id="{{$user->id}}"></td>
