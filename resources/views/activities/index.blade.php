...
<section class="flex mt-6 mb-4 items-center justify-between text-clr-dark-blue">
    ...
    <a href="{{ route('activities.create') }}" class="p-2 border-2 duration-150 border-clr-blue font-medium rounded-md text-clr-blue hover:bg-clr-blue hover:text-clr-white">+
        Add new activity</a>
</section>
